...
Worker.prototype.createDesignDocsInShareSkeleton = function() {
  ...
  return this.when([
    this.promisify( this.couch.database('skeleton/share'), 'save', 'createDesignDocsInShareSkeleton' )( docs[0] ),
    this.promisify( this.couch.database('skeleton/share'), 'save', 'createDesignDocsInShareSkeleton' )( docs[1] )
  ])
}
...
Worker.prototype.createDesignDocsInUsers = function() {
  ...
  return this.promisify( this.couch.database('_users'), 'save', 'createDesignDocsInUsers' )( doc )
}
...
Worker.prototype.createDesignDocsInReplicator = function() {
  ...
  return this.promisify( this.couch.database('_replicator'), 'save', 'createDesignDocsInReplicator' )( doc )
}
