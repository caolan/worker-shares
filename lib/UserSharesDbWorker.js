...
UserSharesDbWorker.prototype._updateAccessSettings = function(databaseName, shareDoc) {
  ...
  Q.when([readersDeferred.promise, writersDeferred.promise]).then(function(promises) {
    ...
    console.log("databaseName %s", databaseName)
...
UserSharesDbWorker.prototype._sendSecurityUpdateRequest = function(databaseName, readers, writers) {
  var options = {
    path   : '_security',
    method : 'PUT',
    json   : {
...
UserSharesDbWorker.prototype._errorCallback = function(error)
{
  console.log("error in WorkerShares");
  console.log( JSON.stringify(error, "", 2) );
};

UserSharesDbWorker.prototype._changeCallback = function(change)
{
...
UserSharesDbWorker.prototype.dropAllDatabases = function(change)
{
