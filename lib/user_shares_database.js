...
util.inherits(UserSharesDatabase, HoodieWorker);
...
UserSharesDatabase.prototype.createDatabase = function() {
  var create = this.promisify( this.database, 'create' )
...
UserSharesDatabase.prototype.setSecurity = function() {
  var query = this.promisify( this.couch.database(databaseName), 'query' )
